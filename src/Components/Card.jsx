...
const Card = ({ title, question, answer, hint1, hint2, cardID }) => {
  ...
  return (
    <>
      <div
        className="rounded shadow-xl min-w-[22rem] max-w-[22rem] cursor-pointer dark:bg-slate-50 min-h-[11rem] max-h-[11rem] bg-slate-800"
        ...
        {clickCardID === cardID ? (
          ...
          <div className="">
            <div className="px-6 py-4">
              ...
              <p className="font-semibold text-white font-Montserrat dark:text-slate-800">
                {question}
              </p>
            </div>
